...
import gffgLogo from "../assets/img/GeeksForGeeks_logo.png";
import ccLogo from "../assets/img/cc-logo.png";
import lcLogo from "../assets/img/LeetCode_logo_black.png";
    ...
    <section className="competitions section section__border" id="competitions">
      <div className="container">
        ...
        <div className="skills-grid">
          ...
          >
            <img src={ccLogo} alt="CodeChef" className="skill-icon" />
            <h3>CodeChef</h3>
          ...
          <article
            ...
            style={{ cursor: "pointer" }}
          >
            <img src={gffgLogo} alt="GeeksforGeeks" className="skill-icon" />
            <h3>GeeksforGeeks</h3>
          ...
          <article
            ...
            style={{ cursor: "pointer" }}
          >
            <img src={lcLogo} alt="LeetCode" className="skill-icon" />
            <h3>LeetCode</h3>
